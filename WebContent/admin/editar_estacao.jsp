...
<f:view>
	...
	<rich:panel header="Editar">
		<a4j:form id="forme">
			<h:panelGrid>
				...
				<a href="cadastrar_tipo.jsf">Cadastrar Tipo click aqui !</a><br />
				
				
				<h:outputText id="rua" value="Logadouro: "  />
				...
				<h:outputText id="id" value="Informe o id do Pluviometro"/>
			...
			<a4j:commandButton value="Editar" action="#{eBean.editar2 }" />
			<h:inputHidden value="#{eBean.enderecoEstacao.idEnderecoEstacao }"/>
			<h:inputHidden value="#{eBean.acessoEstacao.idAcessoEstacao }"/>
			<h:inputHidden value="#{eBean.estacao.idEstacao }"/>
	...
	<a href="listar_estacao.jsf">Voltar</a>
</f:view>
</body>
</html>